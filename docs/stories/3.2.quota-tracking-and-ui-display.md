...
| 2026-01-19 | v0.3 | RPC snapshot + migration addition | Dev |
...
- Quota calcule depuis le texte final post-process, incrementé apres transcription reussie.
...
- Ajout RPC `_quota_weekly_get_or_create` pour creer/relire la ligne quota sans ecrire directement via RLS.
