...
## Tasks / Subtasks
- [ ] Select and integrate local enhancement runtime (WASM/native).
- [ ] Package model assets with clear size/boot-time constraints.
- [ ] Wire enhancement into the capture pipeline **after** diagnostics decide to enhance.
- [ ] Add fallback behavior if model is missing/unavailable.
- [ ] Add feature flag + settings toggle for enhancement.
- [ ] Add performance guards (skip enhancement when under load).
