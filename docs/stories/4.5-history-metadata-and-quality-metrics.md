...
## Tasks / Subtasks
- [ ] Extend the history table/schema to include text stages and metrics (AC: 1,2)
- [ ] Capture metrics during the pipeline and persist with history entries (AC: 2,4)
- [ ] Ensure sync payload includes metadata without blocking (AC: 3)
- [ ] Guard metrics capture with privacy toggles (AC: 5)
- [ ] Add fallback path field and populate on completion (AC: 6)
