...
- [ ] Fix mic selector dropdown population + selection (and unify with settings) (AC: 6,7)
- [ ] Fix contradictory mic detection copy/state (“audio detected” vs “no mic”) (AC: 6,7)
