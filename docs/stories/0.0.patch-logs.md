...
### 0.0.18 - 2026-01-31 - @codex
- Portee: UI | Backend
- Resume: Stabilise la selection micro du dashboard et ajuste le pill du widget.
- Details:
  - Dashboard: stocke le label micro et re-selectionne par label si l'id ne matche pas.
  - Widget: fallback micro par label + selection plus robuste.
  - Widget: pill plus bas et bordure plus blanche.
- Fichiers:
  - dashboard.js
  - renderer.js
  - main.js
...
- Tests:
  - non execute
- Risques/Rollback: revert des changements microphoneLabel/resolveMicrophoneId et styles du pill.

### 0.0.19 - 2026-01-31 - @codex
- Portee: UI
- Resume: Ajoute des notifications de progression pour les imports audio.
- Details:
  - Toasts pour démarrage, succès, échec, annulation.
  - Remplace "Fichier ajouté" par "Import en cours".
- Fichiers:
  - dashboard.js
  - docs/stories/0.0.patch-logs.md
- Tests:
  - non execute
- Risques/Rollback: retirer updateUploadNotifications et restaurer les toasts.
