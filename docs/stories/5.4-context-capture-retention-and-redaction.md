...
- Known limitation: current active window capture (nut-js) only provides window title; app name and url may be unavailable and show as "Inconnue"/"Non disponible" until an OS-specific provider is added.
