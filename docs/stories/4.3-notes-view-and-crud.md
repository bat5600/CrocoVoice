...
- [ ] Fix toolbar hover “icon grows” (no layout shift) (AC: 9)
- [ ] Fix code toggle to reliably toggle off (AC: 10)
- [ ] Add markdown-like list input shortcuts (e.g., “- ” for bullets) (AC: 11)
- [ ] Remove UI flash when deleting notes (AC: 12)
- [ ] Add “Export” from notes row hover actions
