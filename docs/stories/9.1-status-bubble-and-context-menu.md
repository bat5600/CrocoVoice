...
| 2026-02-01 | v0.9 | Persist mic groupId to resolve cross-window IDs | Dev |
...
- Persisted mic groupId to resolve cross-origin deviceId mismatch when dashboard opens later.
