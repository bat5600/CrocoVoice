...
- [ ] Fix submenu hover behavior (mic/language) so it doesn’t close in the “gap” (AC: 7)
- [ ] Unify microphone selector data/source across bubble, settings, onboarding (AC: 8)
- [ ] Add a dashboard entry point for Polish (e.g., section/card/button opening last diff) (AC: 9)
