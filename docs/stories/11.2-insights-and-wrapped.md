...
- [x] Adjust dashboard summary to focus on streaks (remove/de-emphasize active days) (AC: 6)
- [x] Make “total notes” metric clickable → opens Notes tab (AC: 7)
...
| 2026-02-01 | v0.3 | Dashboard streak summary + notes card navigation | Dev |
...
- Replaced active days summary with streak-first card on the dashboard.
- Made the total notes stat open the Notes tab.
- Manual testing completed by user (streak card + notes navigation).
