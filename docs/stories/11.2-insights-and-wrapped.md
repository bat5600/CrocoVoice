...
## Tasks / Subtasks
- [ ] Define metrics queries on local history (AC: 1,3)
- [ ] Implement insights UI in hub (AC: 1,3,5)
- [ ] Add Wrapped summary generation + UI (AC: 2)
- [ ] Ensure privacy gating for any optional sharing/export (AC: 2,4)
