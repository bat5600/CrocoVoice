...
- [ ] Add streaming tokens + “thinking” state in chat UI (AC: 2)
- [ ] Add Clear button to reset chat (AC: 4)
- [ ] Enforce token cap for persisted chat context (default 4,000 tokens; drop oldest) (AC: 5)
- [ ] Adjust CrocOmni typography hierarchy (AC: 6)
