...
## Tasks / Subtasks
- [ ] Add CrocOmni conversation storage (local SQLite) (AC: 2,3)
- [ ] Add CrocOmni UI in the hub (AC: 1,2)
- [ ] Implement conversation list + detail view (AC: 1,2,3)
- [ ] Wire message send/receive to existing AI provider (AC: 4)
