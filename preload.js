...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  listLocalModels: () => ipcRenderer.invoke('local-models:list'),
  installLocalModel: (idOrPreset) => ipcRenderer.invoke('local-models:install', idOrPreset),
  cancelLocalModelDownload: (id) => ipcRenderer.invoke('local-models:cancel', id),
  removeLocalModel: (id) => ipcRenderer.invoke('local-models:remove', id),
